...
public class Network {
    ...
    public boolean connect() {
        try {
            ...
            outputStream = new ObjectOutputStream(socket.getOutputStream()); // чтение
            inputStream = new ObjectInputStream(socket.getInputStream()); // запись
    ...
    public void sendPrivateMessage(String receive, String message) throws IOException {
        sendCommand(Command.privateMessageCommand(receive, message));
    }
    ...
    public void close() {
        try {
            ...
            System.err.println("Failed to close the network connection.");
        }
    }
